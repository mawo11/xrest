...
using XRest.Consul;
using XRest.Restaurants.App;
using XRest.Restaurants.Infratructure;
using XRest.Restaurants.Service.Extensions;
using XRest.Restaurants.Service.Infrastructure;
using XRest.Shared;
...
{
	option.SwaggerDoc("v1", new OpenApiInfo { Title = "XRest.Restaurants.Service ", Version = "v1" });
...
builder.Services.AddHostedService<LocationCacheCheckerService>();
builder.Services.AddHostedService<TransportZoneCacheCheckerService>();
