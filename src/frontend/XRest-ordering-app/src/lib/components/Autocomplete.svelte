<script>
  ...
  export let clearFunction = false;
  ...
  export let noResultsText = $_('autoCompleted.noResultFound');

  // text displayed when async data is being loaded
  export let loadingText = $_('autoCompleted.loading');
...
<div
  ...
  <div class="input-container">
    ...
    <input
      type="text"
      class="{inputClassName ? inputClassName : ''} input autocomplete-input shadow form-control"
      id={inputId ? inputId : ''}
